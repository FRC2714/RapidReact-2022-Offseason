...
public class BallStealAuto extends SequentialCommandGroup {
  public BallStealAuto(SwerveSubsystem swerveSubsystem, Limelight limelight, Shooter shooter, Hood hood, Intake intake,
      Index index) {
    CustomSwerveControllerCommand splineToTeamBall = PathGenerator.PathCommand(swerveSubsystem,
        List.of(
    ...
    CustomSwerveControllerCommand splineToOpposingHubBall = PathGenerator.PathCommand(swerveSubsystem,
        ...
        AutoConstants.kMaxSpeedMetersPerSecond, AutoConstants.kMaxAccelerationMetersPerSecondSquared);
    CustomSwerveControllerCommand splineToHub = PathGenerator.PathCommand(swerveSubsystem,
        List.of(
            new Pose2d(Units.feetToMeters(14.40), Units.feetToMeters(11.34), Rotation2d.fromDegrees(-73.00)),
